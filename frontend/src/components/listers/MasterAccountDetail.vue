<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="AccountName" v-model="item.accountName" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Representative" v-model="item.representative" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="BusinessRegistrationNumber" v-model="item.businessRegistrationNumber" :editMode="editMode" @change="change" />
            </div>
            ...
            <div>
                <String label="CustomerType" v-model="item.customerType" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
